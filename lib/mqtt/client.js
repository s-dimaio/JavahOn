...
class MQTTClient extends EventEmitter {
    ...
    _handleApplianceStatusUpdate(topic, payload) {
        ...
        if (payload.parameters) {
            ...
            if (typeof appliance.updateFromMQTT === 'function') {
                console.log('   📤 Calling appliance.updateFromMQTT()...');
                appliance.updateFromMQTT(payload);
                console.log('   ✅ Appliance updated via updateFromMQTT');
            } else {
                console.warn('   ⚠️  appliance.updateFromMQTT not available, skipping update');
            }
        }
